...
class CrearDB_model extends CI_Model {
	...
	function crearDB(){
		...
		$data = array(
		   ...
		   'contenido' => 'El hotel está ubicado en lo que antiguamente era la mansión de un magnate del petroleo. La extravagancia de su antiguo dueño ha permitido que el hotel disponga de todo tipo de lujos',
		...
		//Servicios
			...
			$data = array('nombre_pista' => 'Tennis','descripcion' => 'Pista de tenis','precio' => '5','cod_servicio' => 1);
			...
			$data = array('nombre_pista' => 'Squash','descripcion' => 'Pista de Squash','precio' => '15','cod_servicio' => 1);

			$this->db->insert('pista', $data);

			$data = array('nombre_pista' => 'Badminton','descripcion' => 'Pista de badminton','precio' => '20','cod_servicio' => 1);

			$this->db->insert('pista', $data);

		/*Alquileres*/

			$data=array('dni'=>'11111111K','cod_servicio'=>1,'codigo_subservicio'=>1,'fecha_entrada'=>'2014-02-05','fecha_salida'=>'2014-02-05','hora_entrada'=>'16:00','hora_salida'=>'17:00');
			$this->db->insert('alquiler', $data);
			$data=array('dni'=>'11111111K','cod_servicio'=>1,'codigo_subservicio'=>1,'fecha_entrada'=>'2014-02-05','fecha_salida'=>'2014-02-05','hora_entrada'=>'18:00','hora_salida'=>'19:00');
			$this->db->insert('alquiler', $data);
			$data=array('dni'=>'11111111K','cod_servicio'=>1,'codigo_subservicio'=>1,'fecha_entrada'=>'2014-02-05','fecha_salida'=>'2014-02-05','hora_entrada'=>'19:00','hora_salida'=>'20:00');
			$this->db->insert('alquiler', $data);
			$data=array('dni'=>'11111111K','cod_servicio'=>1,'codigo_subservicio'=>1,'fecha_entrada'=>'2014-02-07','fecha_salida'=>'2014-02-07','hora_entrada'=>'16:00','hora_salida'=>'17:00');
			$this->db->insert('alquiler', $data);

$(document).ready(function(){
  ...
  $("#imagen1").click(mostrarSlider1);
  $("#imagen2").click(mostrarSlider2);
  $("#imagen3").click(mostrarSlider3);

  $(window).resize(cambioTam);
